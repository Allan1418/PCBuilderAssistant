...
import 'my_builds_model.dart';
export 'my_builds_model.dart';

class MyBuildsWidget extends StatefulWidget {
  const MyBuildsWidget({super.key});

  @override
  State<MyBuildsWidget> createState() => _MyBuildsWidgetState();
}

class _MyBuildsWidgetState extends State<MyBuildsWidget> {
  late MyBuildsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MyBuildsModel());
  }
                        ...
                        return Row(
                          ...
                          children: [
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    FFAppState().buildActual =
                                        _model.salidaBuild?.reference;
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  await columnBuildsRecord.reference.delete();
