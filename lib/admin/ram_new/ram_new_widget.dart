...
import 'ram_new_model.dart';
export 'ram_new_model.dart';

class RamNewWidget extends StatefulWidget {
  const RamNewWidget({super.key});

  @override
  State<RamNewWidget> createState() => _RamNewWidgetState();
}

class _RamNewWidgetState extends State<RamNewWidget> {
  late RamNewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RamNewModel());

    _model.txtRamNameTextController ??= TextEditingController();
    _model.txtRamNameFocusNode ??= FocusNode();

    _model.txtFrequencyRamTextController ??= TextEditingController();
