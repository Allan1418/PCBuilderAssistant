...
export '/menus/menu_admin/menu_admin_widget.dart' show MenuAdminWidget;
export '/login_pages/loggin/loggin_widget.dart' show LogginWidget;
export '/menus/menu_client/menu_client_widget.dart' show MenuClientWidget;
export '/products/new_product/new_product_widget.dart' show NewProductWidget;
export '/products/single_product/single_product_widget.dart'
    show SingleProductWidget;
export '/products/product_list/product_list_widget.dart' show ProductListWidget;
...
export '/am5/vista_cases_a_m5/vista_cases_a_m5_widget.dart'
    show VistaCasesAM5Widget;
export '/am4/vista_cases_a_m4/vista_cases_a_m4_widget.dart'
